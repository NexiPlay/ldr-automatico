-- Somente verificacao. A migration 0384 vem do repositorio nexilead.
do $$
begin
  if to_regclass('public.vw_np_sonar_reputacao') is null
    ...
    raise exception 'SON-2.8: aplicar migration 0384 do nexilead antes de publicar as functions';
  end if;
end;
$$;
